    ...
    <div class="container">
        ...
        <div class="box">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <img src="pproduk/<?php echo $p->product_image ?>"width="100px">
                ...
                <select class="input-control" name="satus">
                    <option value="">--Pilih--</option>
                    <option value="1"  <?php echo ($p->product_satus == 1)? 'selected':''; ?>>Aktif</option>
                    <option value="0" <?php echo ($p->product_satus == 0)? 'selected':''; ?>>Tidak Aktif</option>
                </select>
