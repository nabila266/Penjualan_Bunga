           ...
           <table border="1" cellspacing="0" class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo ($row['product_satus'] == 0)? 'Tidak Aktif' : 'Aktif'; ?></td>
                        <td>
                            <a href="edit-produk.php?id=<?php echo $row['product_id'] ?>">Edit</a> || <a href="proses-hapus.php?idp=<?php 
                            echo $row['product_id'] ?>"onclick="return confirm('Yakin ingin hapus ?');
                            ">Hapus</a>
                        </td>
                    </tr>
                    <?php }}else{ ?>
